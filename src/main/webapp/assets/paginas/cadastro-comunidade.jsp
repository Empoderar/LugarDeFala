	...
	<body>
		<div>
			...
			<form action="#">
				...
				<label for="nomeComunidade">Nome</label> <input type="text" id="nomeComunidade" name="nome" required
					maxlength="50">
				<label for="descricao">Descrição</label> <input type="text" id="descricao" name="descricao" required
					maxlength="500">

	...
	<div>
		<div>
			...
			<form action="inserir-denuncia-de-relato" method="post">
				<input type="submit" value="Spam" name="É spam"> 
				<input type="submit" value="Violação das diretrizes" name="Violando as diretrizes"> 
				<input type="submit" value="Discurso de ódio" name="Discurso de ódio">
			</form>
		</div>
		<hr>
		<div>

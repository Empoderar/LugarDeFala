...
<body>
        ...
        <nav>
            ...
            <div>
                <a href="#">Comunidades</a> <a href="#">Violência física</a> <a
                    href="#">Violência psicolÃ³gica</a> <a href="#">Violência moral</a>
            ...
            <div>
                ...
                <form>
                    <input type="checkbox" id="filtroUsuario" name="filtro1"
                        value="usuarios"> <label for="filtro1">UsuÃ¡rios</label> <input
                    ...
                    <input type="date" id="dataInicio" name="DataInicial"> <label
                        for="dataFinal" id="dataFinal">AtÃ©</label> <input type="date"
    ...
    <div>
        <footer>
            <div>
                <p>Lugar de Fala</p>
                <a href="#">Sobre nÃ³s</a> <a href="#">PÃ¡gina inicial</a>
            </div>
            <div>
                <p>Atendimento</p>
